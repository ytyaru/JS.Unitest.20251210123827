...
class Footer {
    ...
    #copyright() { return small('©', time({datetime:this._created}, '20251210123814'), this.#author()) }
    ...
    #project() { return a(this.#externalLinkAttr(({href:`https://github.com/${this._author}/Unitest/`})), img({class:'icon', src:`${this._prePath}asset/image/logo/github/black.svg`})) }
